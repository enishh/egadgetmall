...
$phone=$_POST['phone'];
$query3=mysqli_query($query,"update customer set Username='$username',Password='$password',Name='$name',Address='$address', Phone_no='$phone' where CustomerID='$id'");
if($query3)
{
header('location:listallcus.php');
}
}
$query1=mysqli_query($query,"select * from customer where CustomerID='$id'");
