...
$image=$_POST['image'];
$price=$_POST['price'];
$query3=mysql_query("update tblproduct2 set name='$name',code='$code',image='$image',price='$price' where id='$id'");
if($query3)
{
header('location:listsatuproduct.php');
}
}
$query1=mysql_query("select * from tblproduct2 where id='$id'");
