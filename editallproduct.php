...
$image=$_POST['image'];
$price=$_POST['price'];
$query3=mysqli_query($query,"update tblproduct set name='$name',code='$code',image='$image',price='$price' where id='$id'");
if($query3)
{
header('location:listallproduct.php');
}
}
$query1=mysqli_query($query,"select * from tblproduct where id='$id'");
$query2=mysqli_fetch_array($query1);
?>
<form method="post" action="">
Item Name :<input type="text" name="name" value="<?php echo $query2['name']; ?>" /><br />
Item Code :<input type="text" name="code" value="<?php echo $query2['id']; ?>" /><br /><br />
